...
namespace Airmax_Payroll_System.Models.Master
{
    public class MasterPayRollApiConfigration : AuditFields
    {
        ...
        public string? DeviceJson { get; set; }  // Keep this for Dapper/Loading
        public string? MappingJson { get; set; } // Keep this for Dapper/Loading

        // Add these to MasterPayRollApiConfigration.cs
        public List<MasterBiomatricDevices>? DeviceList { get; set; }
        public List<MasterLocationDeviceMapping>? MappingList { get; set; }
